...
import com.nequi.uts601.ejb.factory.checkavailability.COCheckAvailabilityFactory;
import com.nequi.uts601.ejb.service.ServiceBean;
import com.nequi.uts601.ejb.util.Constant;

/**
 * Session Bean implementation class CheckAvailabilityFactory
 */
@Singleton(mappedName = Constant.COMMON_STRING_CHECKAVAILABILITY_FACTORY)
@LocalBean
public class CheckAvailabilityFactory implements IFactory {

    @EJB(beanName = Constant.COMMON_STRING_CO_CHECKAVAILABILITY_FACTORY)
    private COCheckAvailabilityFactory factory;
